...
'''try:
    ...
    print(10/0)
print("siva")#output---1,typeerror,zerodivisionerror'''
...
'''try:
    ...
    print(10/0)
print("jagan")#output---1,typeerror'''
...
'''try:
    ...
    print("error occured")
print("jagan") #output ---syntaxerror:expected ':','''